...
const TARGETS: &[Target] = &[
    ...
    Target {
        ...
        aliases: "sidebar places hide show home folder",
    },
    Target {
        id: "sidebar-trash",
        page: "general",
        title: "Show Trash in sidebar",
        aliases: "sidebar places hide show trash",
    },
    Target {
        id: "sidebar-network",
        page: "general",
        title: "Show Network in sidebar",
        aliases: "sidebar places hide show network shares",
    },
    Target {
        id: "sidebar-desktop",
        page: "general",
        title: "Show Desktop in sidebar",
        aliases: "sidebar places hide show desktop folder",
    },
    Target {
        id: "sidebar-documents",
        page: "general",
        title: "Show Documents in sidebar",
        aliases: "sidebar places hide show documents folder",
    },
    Target {
        id: "sidebar-downloads",
        page: "general",
        title: "Show Downloads in sidebar",
        aliases: "sidebar places hide show downloads folder",
    },
    Target {
        id: "sidebar-pictures",
        page: "general",
        title: "Show Pictures in sidebar",
        aliases: "sidebar places hide show pictures folder",
    },
    Target {
        id: "sidebar-videos",
        page: "general",
        title: "Show Videos in sidebar",
        aliases: "sidebar places hide show videos folder",
    },
    Target {
        id: "opening",
        page: "general",
